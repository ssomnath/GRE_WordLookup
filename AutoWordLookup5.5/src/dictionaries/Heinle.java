...
/**
 * This is a Heinle object capable of retrieving dictioanry
 * and thesaurus entries from the nhd.heinle.com website.
 * 
 * @author Suhas Somnath
 *
 */
public class Heinle extends WebDictionary implements WebFunctionalities{
	...
	private String getRawLine(String target){
		try{
			String urlpath = "http://nhd.heinle.com/Definition.aspx?word=";
			    	
			Socket socket = new Socket("nhd.heinle.com",80);
	        ...
	        while ((line = rd.readLine()) != null) {
	        	 ...
	        	 * Catching the line:
	        	 */
	        	if(line.contains("<td class=\"definition\">")){
	        		line = line.trim();
	        		if(line.contains(target)){
	        			/*
		        		 * Working on shortening the line right here:
		        		 */
	        			int indx = line.indexOf("</i>");
	        			
	        			if(indx < 0){
	        				return null;
	        			}
		        		return line.substring(indx+4);
	        		}else{
	        			/*
	        			 * Failure case:
	        			 */
	...
	public static void main(String[] args){
		Heinle ww = new Heinle();
		System.out.println(ww.getRawLine("reputed"));
