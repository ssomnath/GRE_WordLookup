...
/**
 * This is a Longman object capable of retrieving dictioanry
 * and thesaurus entries from the www.ldoceonline.com website.
 * 
 * @author Suhas Somnath
 *
 */
public class Longman extends WebDictionary implements WebFunctionalities{
	...
	private String getRawLine(String target){
		try{
			String urlpath = "http://www.ldoceonline.com/dictionary/";
			    	
			Socket socket = new Socket("www.ldoceonline.com",80);
	        ...
	        wr.write("Host: " + "www.ldoceonline.com" + "\r\n");
	        ...
	        while ((line = rd.readLine()) != null) {
	        	 ...
	        	 * Failure case:
	        	 */
	        	if(line.toLowerCase().contains("The page has not been found, return back to our")){
	        		return null;
	        	}
	        	/*
	        	 * Catching the line:
	        	 */
	        	if(line.contains("class=\"Inflections\">")){
	        		return line.trim();
	        	}
	        }
